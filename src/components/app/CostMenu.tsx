    ...
    <div ref={rootRef} className="relative">
      <button
        ...
        className={clsx(
          ...
          open
            ? "border-acc text-ink"
            : "border-line text-mut hover:border-line3 hover:text-ink",
          focusRing,
        )}
      >
        <span aria-hidden className="h-1.5 w-1.5 shrink-0 rounded-full bg-ok" />
        <span className="font-medium tabular-nums text-ink">{total.primary}</span>
      ...
      {open ? (
        ...
        >
          ...
          <div className="flex flex-col gap-2 border-b border-line2 px-4 py-3">
            ...
            <div className="flex flex-col gap-1.5">
              {summary.byKind.map((row) => (
                <div key={row.kind} className="flex flex-col gap-1">
                  ...
                  <div className="h-[3px] overflow-hidden rounded-sm bg-surface2">
                    <span
          ...
          {summary.searchCount > 0 ? (
            <div className="border-b border-line2 px-4 py-3">
              <div className="flex items-start gap-2 rounded-md border border-warn-line bg-warn-bg px-2.5 py-2 text-[11.5px] leading-relaxed text-warn">
            ...
            <div className="flex max-h-56 flex-col overflow-y-auto">
              {entries.slice(0, 12).map((entry) => (
                ...
                >
                  ...
                  <span className="shrink-0 font-mono text-[10.5px] tabular-nums text-ink">
          ...
          {usdToBrlRate() === null ? (
            <p className="border-t border-line2 bg-canvas px-4 py-2.5 text-[10.5px] leading-relaxed text-mut">
